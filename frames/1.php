...
if(!isset($modx->config['manager_menu_height'])) $modx->config['manager_menu_height'] = '48';
...
<div id="resizer"><a id="hideMenu" onClick="mainMenu.toggleTreeFrame();"><i class="fa fa-chevron-right"></i></a></div>
